...
const TermsAndConditionsClient = dynamic(() => import('./terms-and-conditions-client'), {
    ssr: false,
    loading: () => <TermsAndConditionsSkeleton />,
});
...
export default function TermsAndConditionsLoader() {
