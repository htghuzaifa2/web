    ...
    <footer className="border-t bg-background">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="space-y-4">
            ...
            <div className="text-sm text-muted-foreground">
              <a href="mailto:contact@htg.com.pk" className="hover:text-primary">contact@htg.com.pk</a>
            </div>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="mt-4 flex space-x-4">
              <Link href="https://youtube.com/@htg_pk" target="_blank" rel="noopener noreferrer" aria-label="HTG on Youtube" className="text-muted-foreground hover:text-primary transition-transform hover:scale-110">
                <Youtube className="h-6 w-6" />
              </Link>
              <Link href="https://www.facebook.com/profile.php?id=61576677910935" target="_blank" rel="noopener noreferrer" aria-label="HTG on Facebook" className="text-muted-foreground hover:text-primary transition-transform hover:scale-110">
                <Facebook className="h-6 w-6" />
              </Link>
              <Link href="https://www.instagram.com/htg_pk/" target="_blank" rel="noopener noreferrer" aria-label="HTG on Instagram" className="text-muted-foreground hover:text-primary transition-transform hover:scale-110">
                <Instagram className="h-6 w-6" />
              </Link>
              <Link href="https://wa.me/message/BY3URMYOW3OMH1" target="_blank" rel="noopener noreferrer" aria-label="HTG on WhatsApp" className="text-muted-foreground hover:text-primary transition-transform hover:scale-110">
        ...
        <div className="mt-8 border-t pt-4 text-center text-sm text-muted-foreground transition-colors hover:text-primary">
          &copy; {new Date().getFullYear()} HTG. All Rights Reserved.
        </div>
      </div>
    </footer>
  );
